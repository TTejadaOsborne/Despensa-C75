...
// Categorías de la compra — agrupadas según el recorrido REAL del usuario
// en su Mercadona Las Tablas. El orden es exactamente su flujo por la tienda.
...
// Mapeo de categorías antiguas (todas las versiones previas: las 15 originales
// y las 28 zonas del plano) → categorías nuevas. Migración automática sin pérdida.
const LEGACY_ZONE_MAP = {
  // De la versión inicial (15 categorías genéricas)
  'Frutas y verduras': 'Frutas y verduras',
  'Carnicería y pescadería': 'Carnes',
  'Lácteos y huevos': 'Leche y yogures',
  'Charcutería y quesos': 'Embutidos y quesos',
  'Panadería': 'Pan y desayuno',
  'Despensa': 'Huevos, arroz y pasta',
  'Conservas': 'Huevos, arroz y pasta',
  'Pasta, arroz y legumbres': 'Huevos, arroz y pasta',
  'Desayuno y dulces': 'Pan y desayuno',
  'Aceites y salsas': 'Huevos, arroz y pasta',
  'Bebidas': 'Bebidas',
  'Congelados': 'Chocolate, helados y congelados',
  'Higiene y droguería': 'Baño',
  'Limpieza': 'Limpieza',
  'Otros': 'Otros',

  // De versiones intermedias (Aperitivos eliminado en la versión actual)
  'Aperitivos': 'Embutidos y quesos',

  // De la versión con 28 zonas individuales del plano
  'Comida preparada (caliente)': 'Platos preparados',
  'Comida preparada (nevera)': 'Platos preparados',
  'Bebidas alcohólicas': 'Bebidas',
  'Pescadería': 'Pescadería',
  'Pescado envasado nevera': 'Pescadería',
  'Bebidas y refrescos': 'Bebidas',
  'Helados y chocolates': 'Chocolate, helados y congelados',
  'Patatas fritas': 'Patatas fritas y verdura congelada',
  'Verduras y frutas congeladas': 'Patatas fritas y verdura congelada',
  'Pavo y pollo': 'Carnes',
  'Pasta y aceites': 'Huevos, arroz y pasta',
  'Huevos y legumbres': 'Huevos, arroz y pasta',
  'Ternera y cerdo': 'Carnes',
  'Leche': 'Leche y yogures',
  'Yogures y postres': 'Leche y yogures',
  'Pan/Picos y desayuno/dulces': 'Pan y desayuno',
  'Utensilios de plástico': 'Otros',
  'Café, chocolate y chuches': 'Café y zumos',
  'Zumos': 'Café y zumos',
  'Limpieza hogar': 'Limpieza',
  'Zona baño y cuidado personal': 'Baño',
  'Quesos': 'Embutidos y quesos',
  'Cortador jamón': 'Embutidos y quesos',
  'Embutido aperitivo': 'Embutidos y quesos',
  'Embutido envasado': 'Embutidos y quesos',
  'Frutos secos': 'Embutidos y quesos',
};

const SEED = [
  { name: 'Leche entera 1L',        stock: 3, min: 2, location: 'Nevera',    zone: 'Leche y yogures' },
  { name: 'Huevos (docena)',        stock: 1, min: 1, location: 'Nevera',    zone: 'Huevos, arroz y pasta' },
  { name: 'Yogur natural',          stock: 6, min: 4, location: 'Nevera',    zone: 'Leche y yogures' },
  { name: 'Queso fresco',           stock: 2, min: 1, location: 'Nevera',    zone: 'Embutidos y quesos' },
  { name: 'Pan de molde',           stock: 1, min: 1, location: 'Despensa',  zone: 'Pan y desayuno' },
  ...
  { name: 'Pechuga de pollo',       stock: 2, min: 2, location: 'Nevera',    zone: 'Carnes' },
  { name: 'Salmón fresco',          stock: 1, min: 1, location: 'Nevera',    zone: 'Pescadería' },
  { name: 'Arroz',                  stock: 2, min: 1, location: 'Despensa',  zone: 'Huevos, arroz y pasta' },
  { name: 'Pasta',                  stock: 3, min: 2, location: 'Despensa',  zone: 'Huevos, arroz y pasta' },
  { name: 'Lentejas',               stock: 2, min: 1, location: 'Despensa',  zone: 'Huevos, arroz y pasta' },
  { name: 'Aceite de oliva',        stock: 1, min: 1, location: 'Despensa',  zone: 'Huevos, arroz y pasta' },
  { name: 'Vinagre',                stock: 1, min: 1, location: 'Despensa',  zone: 'Huevos, arroz y pasta' },
  { name: 'Agua 1.5L (pack)',       stock: 2, min: 2, location: 'Despensa',  zone: 'Bebidas' },
  { name: 'Café molido',            stock: 1, min: 1, location: 'Despensa',  zone: 'Café y zumos' },
  { name: 'Cereales',               stock: 2, min: 1, location: 'Despensa',  zone: 'Pan y desayuno' },
  { name: 'Atún en lata',           stock: 6, min: 4, location: 'Despensa',  zone: 'Huevos, arroz y pasta' },
  { name: 'Verduras congeladas',    stock: 2, min: 1, location: 'Congelador', zone: 'Patatas fritas y verdura congelada' },
  { name: 'Pizza congelada',        stock: 2, min: 1, location: 'Congelador', zone: 'Chocolate, helados y congelados' },
  { name: 'Papel higiénico (pack)', stock: 1, min: 1, location: 'Otros',     zone: 'Baño' },
